...
class OccupancyMap:
    ...
    def draw_filled(self, ax):
        ...
        while not it.finished:
            if self.map[it.multi_index] is True:
                ...
                c = shapes.Cuboid(ax, xmax - xmin, ymax - ymin, zmax - zmin, alpha=0.1,
                                  linewidth=1, edgecolors='k', facecolors='b')
